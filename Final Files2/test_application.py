...
from main import create_habit, add_checkpoint, generate_random_habits, generate_fake_checkpoints, get_habits, get_user_input, delete_habit
...
def test_generate_fake_checkpoints():
    ...
    generate_fake_checkpoints(session)  # Pass the session object as a parameter
...
#     checkpoint1 = Checkpoint(date=datetime(2023, 6, 1))
#     checkpoint2 = Checkpoint(date=datetime(2023, 6, 3))
...
#     habit1 = Habit(task='Exercise', frequency=Frequency.DAILY)
#     checkpoint1 = Checkpoint(date=datetime(2023, 6, 1))
#     checkpoint2 = Checkpoint(date=datetime(2023, 6, 2))
#     checkpoint3 = Checkpoint(date=datetime(2023, 6, 3))
#     checkpoint4 = Checkpoint(date=datetime(2023, 6, 6))
...
#     habit2 = Habit(task='Read a book', frequency=Frequency.WEEKLY)
#     checkpoint5 = Checkpoint(date=datetime(2023, 5, 29))
#     checkpoint6 = Checkpoint(date=datetime(2023, 6, 5))
#     checkpoint7 = Checkpoint(date=datetime(2023, 6, 12))
#     checkpoint8 = Checkpoint(date=datetime(2023, 6, 19))
...
#     checkpoint1 = Checkpoint(date=datetime(2023, 6, 1))
#     checkpoint2 = Checkpoint(date=datetime(2023, 6, 2))
#     checkpoint3 = Checkpoint(date=datetime(2023, 6, 4))  # Gap of one day
#     checkpoint4 = Checkpoint(date=datetime(2023, 6, 5))
#     habit1.checkpoints = [checkpoint1, checkpoint2, checkpoint3, checkpoint4]
#
